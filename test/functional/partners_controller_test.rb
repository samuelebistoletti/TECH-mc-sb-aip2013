...
class PartnersControllerTest < ActionController::TestCase
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post :create, partner: { description: @partner.description, external_link: @partner.external_link, image_url: @partner.image_url, name: @partner.name }
    end
  ...
  test "should update partner" do
    put :update, id: @partner, partner: { description: @partner.description, external_link: @partner.external_link, image_url: @partner.image_url, name: @partner.name }
    assert_redirected_to partner_path(assigns(:partner))
  end
